...
The same token is also used for wildcard Let’s Encrypt certificates via DNS-01 validation.
...
| `CLOUDFLARE_API_TOKEN` | API token with DNS edit permissions and wildcard DNS-01 certificate support |  ❌ Optional | `01ab23cd45ef6789ghij0123klmn4567opqrs890tuvwx` |
